...
VALUES (
    ...
    VALUES
        (v_user_id, 'Minerva University', 'Alumni Ambassador Western Europe', 'Sep 2024', 'Pågående',
        ...
        (v_user_id, 'House of Beans, Hötorgshallen', 'Försäljare/Barista', 'Aug 2024', 'Feb 2025',
        ...
        (v_user_id, 'Profilgruppen', 'Anodiseringsoperatör (Feriearbete)', 'Juli 2024', 'Aug 2024',
         ...
         ARRAY['industry'], 3),
        (v_user_id, 'Max Hamburgare', 'Restaurangbiträde', 'April 2024', 'Aug 2024',
         ...
         ARRAY['restaurant'], 4),
        (v_user_id, 'Keeping Tabs', 'Multimedia Technical Specialist', 'Nov 2022', 'Juni 2023',
         ...
         ARRAY['art', 'office'], 5),
        (v_user_id, '30 Campos Eliseos', 'Kubistisk målare', '2022', '2024',
         ...
         ARRAY['art'], 6),
        (v_user_id, 'TikTok/ByteDance', 'Kvalitetsgranskare - Amerikanska marknaden', 'Maj 2022', 'Juni 2022',
        ...
        (v_user_id, 'YouTube Ads (via Vaco)', 'Innehållsmoderator - Svenska marknaden', 'Feb 2022', 'Juni 2022',
        ...
        (v_user_id, 'Clubhouse (via Vaco)', 'Innehållsmoderator - Skandinaviska och amerikanska marknaden', 'Juni 2021', 'Jan 2022',
        ...
        (v_user_id, 'Svensk-amerikanska handelskammaren', 'Marknadsföring och försäljningsutveckling', 'Juni 2021', 'Sep 2021',
        ...
        (v_user_id, 'Minerva University', 'Handledare för examensprojekt', 'Sep 2020', 'Maj 2021',
         ...
         ARRAY['office', 'art'], 11),
        (v_user_id, 'Kvarngården äldreboende', 'Timvikarie', 'Maj 2020', 'Sep 2020',
         ...
         ARRAY['healthcare'], 12),
        (v_user_id, 'Minerva Project', 'Marknadsföring/Kundservice - Global Marketing Team', 'Sep 2019', 'April 2020',
        ...
        (v_user_id, 'Google Ads (via Vaco)', 'Svensk innehållsanalytiker för gTech', 'Maj 2018', 'April 2019',
        ...
        (v_user_id, 'Minerva Project - Student Experience Team', 'Evenemangskoordinator och elevhemsvärd', 'Sep 2017', 'Maj 2018',
        ...
        (v_user_id, 'Wallby Säteri', 'Gårdsvärd/Receptionist', 'Juni 2016', 'Aug 2016',
        ...
        (v_user_id, 'ICA Maxi Stormarknad', 'Kassapersonal, frukt och grönt', '2015', '2019',
         ...
         ARRAY['retail'], 17),
        (v_user_id, 'Coffeehouse by George', 'Cafépersonal', '2014', '2015',
         'Kassahantering och barista. Hög servicenivå i centralt läge.',
         ARRAY['restaurant'], 18),
        (v_user_id, 'Siggesta Gård', 'Gårdsvärd/Trädgårdsarbetare', '2014', '2015',
    ...
    VALUES
        (v_user_id, 'Minerva University', 'B.S in Social Science, Economics and Business Administration', 'Business, Arts & Humanities', 'San Francisco, USA', 'Aug 2017', 'Maj 2021'),
        (v_user_id, 'United World College Red Cross Nordic', 'International Baccalaureate Bilingual Diploma - Engelska och Svenska (GPA: 3.85)', 'International Baccalaureate', 'Flekke, Norge', 'Aug 2015', 'Maj 2017');
    ...
    VALUES
        (v_user_id::text, 'LEAF (Living Environment and Future)', '2016 - 2017',
        ...
        (v_user_id::text, 'The Right Solution Project', 'Mars 2013 - April 2015',
        ...
        (v_user_id::text, 'India Unlimited Utbytesprogram', 'Nov 2014 - Feb 2015',
        ...
        (v_user_id::text, 'Värmdö Församling', '2012 - 2014',
    ...
    VALUES
        (v_user_id::text, '1:a pris Stockholms Konstsalong 2024 - Jurybedömd utställning, nominerad Publikens Favorit', 1),
        (v_user_id::text, '1:a pris Greenpoint Gallery Brooklyn 2023 - Vann bland 60 konstnärer, fick solouställning', 2),
        (v_user_id::text, '1:a pris Murray''s Creative Contest 2022 - Detroit-baserad tävling med specialdesign', 3),
        (v_user_id::text, 'Global Startup Weekend Stockholm - Vinnare för Terra Finance (Google for Startups & Techstars)', 4),
        (v_user_id::text, 'Tredje pris Chinese Bridge - Nationell tävling i kinesiskt språk, Bergen 2016', 5),
        (v_user_id::text, 'Röda Korsets diplom - Guldutmärkelse för teamwork och ledarskap (100+ volontärtimmar)', 6),
        (v_user_id::text, 'Minerva University Award for Initiative 2018', 7);
    ...
    VALUES
        (v_user_id::text, 'restaurant', 'Restaurang & Café', 'Service, tempo, kundkontakt',
         ARRAY['servitör', 'servitris', 'restaurang', 'café', 'barista', 'kök'], true, 1),
        (v_user_id::text, 'retail', 'Butik & Kassa', 'Försäljning, kassa, kundservice',
         ARRAY['butik', 'kassa', 'säljare', 'ica', 'coop'], true, 2),
        (v_user_id::text, 'customerservice', 'Kundtjänst & Support', 'Kommunikation, problemlösning, internationell erfarenhet',
         ARRAY['kundtjänst', 'support', 'kundservice', 'helpdesk'], true, 3),
        (v_user_id::text, 'content', 'Content & Moderation', 'Trust & Safety, policy, granskning',
         ARRAY['moderator', 'content', 'review', 'granskning', 'trust'], true, 4),
        (v_user_id::text, 'tech', 'Tech & Kontor', 'Analytiskt arbete, data, tech-bolag',
         ARRAY['tech', 'IT', 'data', 'analyst', 'kontor'], true, 5),
        (v_user_id::text, 'industry', 'Industri & Trädgård', 'Fysiskt arbete, skift, materialhantering',
         ARRAY['industri', 'lager', 'produktion', 'operatör', 'trädgård'], true, 6),
        (v_user_id::text, 'healthcare', 'Vård & Omsorg', 'Omvårdnad, empati, medicinhantering',
         ARRAY['vård', 'omsorg', 'äldre', 'sjukvård'], true, 7),
        (v_user_id::text, 'art', 'Konst & Kultur', 'Konstnärligt arbete, utställningar, projektledning',
